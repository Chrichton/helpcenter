...
config :helpcenter, HelpcenterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "GDMskqP6wCeXqpq8vLYhvGOLrifOH7v2LT00lTK/idjQVFn8mBzuAMCRzY2CNEHW",
  watchers: [
...
config :helpcenter, dev_routes: true, token_signing_secret: "4wkaBn0Dt5mQ/ExJchVC1Z9Pd8ol8RcH"
